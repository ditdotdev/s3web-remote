# Datadatdat S3 Web Provider

This is a basic Datadatdat read-only web provider designed to work with commits pushed by the S3
remote provider. For more information on how it works, consult the datadatdat documentation.
