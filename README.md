...
This is a basic Dit read-only web provider designed to work with commits pushed by the S3
remote provider. For more information on how it works, consult the dit documentation.
